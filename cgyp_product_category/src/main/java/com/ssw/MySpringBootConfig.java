...
public class MySpringBootConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        excludePathPaterns1.add("/manage/category/{categoryId}");
        excludePathPaterns1.add("/manage/category/see.do");
        excludePathPaterns1.add("/manage/category/deep/{categoryId}");
        excludePathPaterns1.add("/manage/productBrand/search.do");
        excludePathPaterns1.add("/manage/product/hot.do");
        //excludePathPaterns1.add("/manage/product/save.do");//
        excludePathPaterns1.add("/manage/product/new.do");
        excludePathPaterns1.add("/manage/product/detail.do");
        excludePathPaterns1.add("/manage/product/search.do");
        excludePathPaterns1.add("/manage/product/seller_pro.do");
        excludePathPaterns1.add("/manage/product/spec_pro.do");
        excludePathPaterns1.add("/manage/product/convertible_pro.do");
        //拦截后台
